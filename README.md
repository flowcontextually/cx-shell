...
curl -sL https://github.com/flowcontextually/cx-shell/releases/download/v0.5.2/cx-v0.5.2-linux-x86_64.tar.gz | tar -xz
...
curl -sL https://github.com/flowcontextually/cx-shell/releases/download/v0.5.2/cx-v0.5.2-macos-x86_64.tar.gz | tar -xz
sudo mv cx /usr/local/bin/
cx --version
```
...
$url = "https://github.com/flowcontextually/cx-shell/releases/download/v0.5.2/cx-v0.5.2-windows-amd64.zip"
$output = "cx.zip"
