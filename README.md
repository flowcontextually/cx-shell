...
curl -sL https://github.com/flowcontextually/cx-shell/releases/download/v0.5.8/cx-v0.5.8-linux-x86_64.tar.gz | tar -xz
...
curl -sL https://github.com/flowcontextually/cx-shell/releases/download/v0.5.8/cx-v0.5.8-macos-x86_64.tar.gz | tar -xz
sudo mv cx /usr/local/bin/
cx --version
```
...
$url = "https://github.com/flowcontextually/cx-shell/releases/download/v0.5.8/cx-v0.5.8-windows-amd64.zip"
$output = "cx.zip"
