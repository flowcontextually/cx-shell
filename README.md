...
curl -sL https://github.com/flowcontextually/cx-shell/releases/download/v0.5.7/cx-v0.5.7-linux-x86_64.tar.gz | tar -xz
...
curl -sL https://github.com/flowcontextually/cx-shell/releases/download/v0.5.7/cx-v0.5.7-macos-x86_64.tar.gz | tar -xz
sudo mv cx /usr/local/bin/
cx --version
```
...
$url = "https://github.com/flowcontextually/cx-shell/releases/download/v0.5.7/cx-v0.5.7-windows-amd64.zip"
$output = "cx.zip"
