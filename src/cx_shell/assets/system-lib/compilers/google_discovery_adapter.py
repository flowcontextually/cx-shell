# /home/dpwanjala/repositories/cx-shell/src/cx_shell/assets/system-lib/compilers/google_discovery_adapter.py
...
def _generate_pydantic_code(spec: Dict[str, Any]) -> str:
    ...
    header = [
        "# Generated by the Contextually Blueprint Compiler (Google Discovery Adapter)",
